...
from analysis import ScatterAnalysis, HistogramAnalysis, BoxAnalysis, ContourAnalysis, KMeansAnalysis, DFAAnalysis, LSTMAnalysis, PSAAnalysis, ProphetAnalysis, MassEstimation
